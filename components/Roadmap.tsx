          ...
          <div className="w-full aspect-[4/5] border border-white/10 relative flex items-center justify-center p-6 md:p-8 overflow-hidden bg-black shadow-inner">
            ...
            <div className="relative w-full h-full flex items-center justify-center">
               <div className="w-3/4 h-1/2 border-2 border-white/30 relative modern-transition">
                  ...
                  <div className="absolute bottom-2 left-2 text-[8px] uppercase tracking-[0.2em] text-white/30">STEP 1</div>
               </div>
        ...
        <div className="lg:col-span-2 space-y-12">
          ...
          <div className="space-y-12 relative pl-2">
            ...
            {STAGES.map((s, i) => {
              ...
              const past = s.id < 1;
              return (
                <div key={s.id} className={`relative pl-12 modern-transition ${active ? 'opacity-100 scale-100' : 'opacity-30 hover:opacity-70'}`}>
                  <div className={`absolute left-0 top-1 w-7 h-7 border modern-transition flex items-center justify-center ${
                    active ? 'bg-white border-white scale-110 shadow-[0_0_20px_rgba(255,255,255,0.2)]' : 'bg-black border-white/20'
                  }`}>
