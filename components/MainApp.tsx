...
import { BudgetCreator } from './BudgetCreator/BudgetCreator';
...
export const MainApp: React.FC = () => {
    ...
    // State for roadmap data and functions
    const [roadmapData, setRoadmapData] = useState<any[]>([]); // Assuming roadmapData type
    const checkItem = (itemId: string) => {
        // Placeholder for checkItem logic
                ...
                <div className="flex h-screen bg-black text-white font-sans overflow-hidden">
                    ...
                    <main className="flex-1 flex flex-col relative overflow-y-auto bg-black pb-24 md:pb-0">
                        ...
                        <div className="flex-1">
                            ...
                            {activeTab === AppTab.Roadmap && <Roadmap roadmapData={roadmapData} checkItem={checkItem} />}
                            ...
                            {activeTab === AppTab.BudgetCreator && <BudgetCreator />}
